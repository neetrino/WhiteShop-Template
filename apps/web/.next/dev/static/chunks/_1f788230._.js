...
"[project]/apps/web/app/admin/delivery/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DeliveryPage() {
    ...
    const fetchDeliverySettings = async ()=>{
        try {
            ...
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get('/api/v1/admin/delivery');
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].put('/api/v1/admin/delivery', {
                locations
            });
...
_s(DeliveryPage, "hMMeVsODPPmtmqt05oBlxx+DaAs=", false, function() {
    return [
...
//# sourceMappingURL=_1f788230._.js.map