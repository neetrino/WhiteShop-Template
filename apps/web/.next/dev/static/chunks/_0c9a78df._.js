...
"[project]/apps/web/app/admin/messages/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MessagesPage() {
    ...
    const fetchMessages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MessagesPage.useCallback[fetchMessages]": async ()=>{
            try {
                setLoading(true);
                console.log('📧 [ADMIN] Fetching messages...', {
                    page
                });
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get('/api/v1/admin/messages', {
                    params: {
                        page: page.toString(),
                        limit: '20'
                    }
    ...
    }["MessagesPage.useCallback[fetchMessages]"], [
        page
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MessagesPage.useEffect": ()=>{
...
_s(MessagesPage, "LALZ7ZgWLh15l9M0lFz7HBkHFOE=", false, function() {
    return [
...
//# sourceMappingURL=_0c9a78df._.js.map