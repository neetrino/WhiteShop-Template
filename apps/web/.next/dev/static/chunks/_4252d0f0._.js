...
"[project]/apps/web/app/admin/settings/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SettingsPage() {
    ...
    const fetchSettings = async ()=>{
        try {
            ...
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get('/api/v1/admin/settings');
            setSettings({
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].put('/api/v1/admin/settings', {
...
_s(SettingsPage, "UdMpSoz9pS7sCP8z68Kz80al9n4=", false, function() {
    return [
...
//# sourceMappingURL=_4252d0f0._.js.map