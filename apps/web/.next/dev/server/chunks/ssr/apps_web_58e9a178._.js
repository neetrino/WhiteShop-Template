...
function useAttributes() {
    ...
    const fetchAttributes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get('/api/v1/admin/attributes');
    ...
    const handleCreateAttribute = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/api/v1/admin/attributes', {
    ...
    const handleDeleteAttribute = async (attributeId, attributeName)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].delete(`/api/v1/admin/attributes/${attributeId}`);
    ...
    const handleUpdateAttributeName = async (attributeId)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].patch(`/api/v1/admin/attributes/${attributeId}/translations`, {
                name: trimmedName,
                locale: 'en'
            });
    ...
    const handleAddValue = async (attributeId)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post(`/api/v1/admin/attributes/${attributeId}/values`, {
                label: trimmedValue,
                locale: 'en'
            });
    ...
    const handleDeleteValue = async (attributeId, valueId, valueLabel)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].delete(`/api/v1/admin/attributes/${attributeId}/values/${valueId}`);
    ...
    const handleUpdateValue = async (data)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].patch(`/api/v1/admin/attributes/${editingValue.attributeId}/values/${editingValue.value.id}`, {
                ...data,
                locale: 'en'
            });
